    ...
    <>
      <section className="cursor-pointer xl:pt-0">
        <div
          ...
          className="grid space-y-10 lg:grid-cols-3 my-12 md:my-10 md:mx-20 mx-2 place-items-center border-y-[#FF2C2C] border-2 border-x-0"
        >
          <h3 className="lg:col-span-3 mb-4 relative text-left mt-4 font-Syne font-bold inline-block lg:text-[36px] lg:leading-[58px] text-[#FF2C2C] text-[22px] leading-[28.4px] py-4 lg:py-6">
