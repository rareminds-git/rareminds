...
const CTA = ({ content }) => {
  ...
  return (
    <>
      <section className="md:px-5 md:px-10 cursor-pointer">
        <div
          onClick={() => navigate("/unlock-your-potential")}
          className="grid space-y-10 md:grid-cols-3 my-12 md:mx-32 place-items-center border-y-red-200 border-2 border-x-0"
        >
