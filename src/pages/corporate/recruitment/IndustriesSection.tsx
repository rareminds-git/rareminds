...
const IndustriesSection = () => {
  ...
  return (
    <section
      id="industries"
      className="section w-full flex relative overflow-hidden"
    >
      <img
        src="/images/corporate/recruitment/industries/bg.jpeg"
        className="w-full"
      />

      <div className="absolute left-1/2 -translate-x-1/2 top-0 mt-20 z-10 max-w-[591px]">
        <h2 className="text-3xl md:text-5xl font-bold mb-6 w-max mx-auto">
          Industries We Serve
        </h2>
        <p className="text-center mx-auto">
          Rareminds is a global recruitment and cross-border talent acquisition
          firm based in India, specializing in hiring third-country nationals
      ...
      <Button
        onClick={scrollToCaseStudies}
        className="absolute left-1/2 -translate-x-1/2 bottom-[100px] bg-corporate-secondary text-white hover:bg-white/90 hover:text-corporate-secondary shadow-lg shadow-red-950/20"
      >
        See Our Impact Stories
      </Button>
    </section>
