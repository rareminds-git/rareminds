    ...
    <div className="h-autopx-8 bg-white py-8" data-aos="fade-down-right">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto mb-6">
          <h1 className="text-[48px] text-center font-bold mb-2">Downloadable Resources</h1>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-6 mt-16">
  ...
  <img src="/images/academy/5-Day TDP Calendar (Customizable).svg" alt="" className="w-8 h-8 md:w-12 md:h-12 "  />
  {/* Heading */}
  ...
  {/* Icon/Image below content */}
  <img src="/images/academy/Career Counselling Blueprint.svg" alt="" className="w-8 h-8 md:w-12 md:h-12 "  />
  {/* Heading */}
  <h2 className="text-[18px] font-semibold mb-2">
  ...
  {/* Icon/Image below content */}
  <img src="/images/academy/NEP-Ready School Checklist.svg" alt="" className="w-8 h-8 md:w-12 md:h-12  "  />
  {/* Heading */}
  <h2 className="text-[18px] font-semibold mb-2">
