...
const Govt = ({ onAction }: { onAction: (msg: string) => void }) => {
  const triggerParentFunction = () => {
    onAction("government");
  };
  return (
    <div
      className="clipped-govt hover:scale-[1.1] transition-all duration-300 hover:cursor-pointer hover:z-[1]"
