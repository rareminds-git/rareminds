...
const Header = ({ navbarOpen, setNavbarOpen }) => {
  ...
  return (
    <header className="w-full fixed top-0 left-0 px-2 py-4 sm:py-0 flex z-[100] bg-white shadow-md overflow-hidden h-[80px] items-center">
      <div className="">
        <Link to="/">
          <img
            src={Logo}
      ...
      <div className="flex ml-auto">
        {!navbarOpen && (
          <select
            className="top-nav-dropdown hidden sm:block mt-3 "
