...
const CTA = ({ content, contactPage }) => {
  ...
  return (
    <>
      <section className="items-center cursor-pointer xl:px-28 lg:px-20 md:px-16 px-8 xl:pb-16 lg:pb-16 md:pb-8 pb-4 xl:py-16 lg:py-20 md:py-16 py-8">
        <div
          onClick={() => navigate("/unlock-your-potential")}
          className="border-y-2 border-[#FF2C2C] px-8 py-6 w-full sm:w-auto max-w-xs sm:max-w-none text-center sm:text-left"
        >
